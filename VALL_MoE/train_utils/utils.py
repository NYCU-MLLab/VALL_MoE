...
def add_model_arguments(parser: argparse.ArgumentParser):
    ...
    parser.add_argument(
        ...
        type=int,
        default=1024,
        help="The dimension of the decoder.",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=16,
        help="The number of heads in the multi-head attention.",
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=1.0,
        help="The scale factor for the model.",
    )
    ...
    parser.add_argument(
        ...
        type=str2bool,
        default=True,
        help="Whether to use norm-first in the transformer.",
    )
    ...
    parser.add_argument(
        ...
        type=str2bool,
        default=False,
        help="Whether to add prenet to the model.",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=0,
        help="The prefix mode for the model.",
    )
    ...
    parser.add_argument(
        ...
        type=str2bool,
        default=True,
        help="Whether to share the embedding between encoder and decoder.",
    )
    ...
    parser.add_argument(
        ...
        type=str2bool,
        default=False,
        help="Whether to use scaling in xformers.",
    )

    # Add MoE-related arguments
    parser.add_argument(
        "--use-moe",
        type=str2bool,
        default=False,
        help="Whether to use Mixture of Experts (MoE) in the last 2 layers.",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=3,
        help="Number of routed experts in MoE layers.",
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.5,
        help="Scale factor for routed experts' hidden size relative to shared expert.",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=1,
        help="Number of experts to route to in MoE layers.",
    )
